...
| Three-tier memory output | Automated (pipeline + OpenClaw) | physical-logs, physical-insights, physical-pattern.md changes, plus OpenClaw native memory changes | Phase 1 | RQ3 |
